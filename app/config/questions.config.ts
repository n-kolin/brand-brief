...
const allQuestions: QuestionnaireType[] = [
    {
        ...
        questions: [
            ...
            {
                type: 'TEXT',
                id: 'closing-business-info',
                question: 'לפני שעוברים לחלק הבא - יש לך עוד משהו חשוב לציין על העסק שלך?',
                answer: '',
                defaultAnswer: '',
    ...
    },
    {
        ...
        questions: [
            ...
            },
            {
                ...
                question: 'לפני שעוברים לחלק הבא - יש לך עוד משהו חשוב לציין על התחרות והשוק?',
                answer: '',
                defaultAnswer: '',
                isClosingQuestion: true,
            },
    ...
    },
    {
        ...
        questions: [
            ...
            {
                type: 'TEXT',
                id: 'closing-existing-identity',
                question: 'לפני שעוברים לחלק הבא - יש לך עוד משהו חשוב לציין על הזהות הויזואלית הקיימת?',
                answer: '',
                defaultAnswer: '',
                isClosingQuestion: true,
            },
    ...
    },
    {
        ...
        questions: [
            ...
            {
                type: 'TEXT',
                id: 'closing-design-preferences',
                question: 'לפני שעוברים לחלק הבא - יש לך עוד משהו חשוב לציין על העדפות העיצוב שלך?',
                answer: '',
                defaultAnswer: '',
                isClosingQuestion: true,
            },
    ...
    },
    {
        ...
        questions: [
            ...
            {
                type: 'TEXT',
                id: 'closing-target-audience',
                question: 'לפני שמסיימים - יש לך עוד משהו חשוב לציין על קהל היעד או המסר של המותג?',
                answer: '',
                defaultAnswer: '',
                isClosingQuestion: true,
            },
